...
public class ProductActyvity extends AppCompatActivity {
    ...
    private void LoadMoreData() {
        lv_SanPham.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("product_info", arrayListSanPham.get(position));
                startActivity(intent);
            }
        });
    ...
    private void getProduct(int Page) {
        String url = Server.urlGetProductByIDType + page;
    ...
    private void getIDType() {
        idType = getIntent().getExtras().getInt("id_product_type");
        CharSequence tmp = getIntent().getExtras().getString("product_name");
