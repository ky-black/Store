...
public class ProductTypeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtTenLoaiSP.setText(loaiSP.getProduct_type_name() );
        Picasso.with(context).load(loaiSP.getPicture()).placeholder(R.drawable.loading).error(R.drawable.error).into(viewHolder.imgLoaiSP);
