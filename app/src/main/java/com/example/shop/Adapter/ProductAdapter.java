...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ...
        holder.txtTenSanPham.setText(sanPham.getProduct_name());
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        holder.txtGiaSanPham.setText("Giá: "+ decimalFormat.format(Integer.parseInt(sanPham.getPrice()))+ "Đ" );
        Picasso.with(context).load(sanPham.getPicture()).placeholder(R.drawable.loading).error(R.drawable.error).into(holder.imgHinhAnhSanPham);
    }
